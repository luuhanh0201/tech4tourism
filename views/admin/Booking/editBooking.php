<div class="container py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h2 class="fw-bold">Chỉnh sửa booking</h2>
            ...
            <div class="col-lg-8">
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <select class="form-select" name="tour_id" id="tourSelect" required>
                                <?= empty($_SESSION['error_tour']) ?>
                                <!-- <option value="0" selected>-- Chọn tour --</option> -->
                                <?php foreach ($tours as $tour): ?>
                                    <?php if ($tour['status'] === "active"): ?>
                                        <?php if ($tour['id'] === $booking['id']): ?>
                                            <option value="<?= $tour['id'] ?>" data-price="<?= $tour['price'] ?>" selected>
                                                <?= $tour['tour_name'] ?>
                                            </option>
                                        <?php endif; ?>
                ...
                <div class="card-section mb-4">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            <label class="form-label">Số Điện Thoại <span class="text-danger" required>*</span></label>
            ...
            <div class="col-lg-4">
                ...
                <div class="card-section summary-card mb-4">
                    ...
                    <div class="summary-item">
                        ...
                        <strong id="total_customer">1 người</strong>
                        <input type='text' hidden name="max_person" />
                    </div>
                    ...
                    <div class="summary-total">
                        ...
                        <input type='number' name="price" id="price" hidden />
                    </div>
...
<script>
    ...
    function updateTotalPrice() {
        ...
        totalPriceInput.innerText = price.toLocaleString('vi-VN') + ' đ';
    }
    ...
    document.addEventListener('DOMContentLoaded', function () {
        ...
        // số index hiện tại (đang có sẵn 1 khách: index = 0)
        let guestIndex = customerList.querySelectorAll('.guest-item').length - 1;
                        ...
                        <div class="mb-3">
                                    ...
                                    <div class="form-check mb-2">
                                        <input class="form-check-input" type="checkbox" name="customer[${guestIndex}][customer_note_type]"
                                            value="wheelchair" id="wheelchair">
