<div class="container new-tour-page py-5">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <div>
            <h2 class="fw-bold mb-1">Chỉnh sửa tour</h2>
                        ...
                        <div class="col-md-4">
                            ...
                            <select name="category_id" class="form-select form-control-rounded" required>
                                ...
                                <?php foreach ($categories as $category): ?>
                                    <?php if ($category['name'] == $tour['category_name']): ?>
                ...
                <div class="card-section">
                    ...
                    <div class="row g-3">
                        <div class="col-md-6">
                            ...
                            <input value="<?=$tour['duration_day']?>" type="number" name="duration_day" min="1" class="form-control form-control-rounded"
                                placeholder="Ví dụ: 5">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Số đêm</label>
                            <input value="<?=$tour['duration_night']?>" type="number" name="duration_night" min="0" class="form-control form-control-rounded"
                                placeholder="Ví dụ: 4">
                        </div>
                        ...
                        <div class="col-md-6">
                            ...
                            <input value="<?=$tour['start_location']?>" type="text" name="start_location" class="form-control form-control-rounded"
                                placeholder="Hà Nội, Hồ Chí Minh...">
                        </div>
                        <div class="col-md-6">
                            <label class="form-label">Điểm kết thúc</label>
                            <input value="<?=$tour['end_location']?>" type="text" name="end_location" class="form-control form-control-rounded"
                    ...
                    <div class="row g-3">
                        <div class="col-12">
                            ...
                            <div class="input-group">
                                <input value="<?=$tour['price']?>" type="number" name="price" min="0" step="1000" class="form-control"
